        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LogoFileName = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResumeOriginalName = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProfileViews_EmployerProfiles_EmployerProfileId",
                        column: x => x.EmployerProfileId,
                        principalTable: "EmployerProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProfileViews_JobSeekerProfiles_JobSeekerProfileId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProfileViews_EmployerProfileId",
                table: "ProfileViews",
                column: "EmployerProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_ProfileViews_JobSeekerProfileId_ViewedAt",
                table: "ProfileViews",
                columns: new[] { "JobSeekerProfileId", "ViewedAt" });
        }
